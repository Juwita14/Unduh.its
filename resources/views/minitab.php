                                                ...
                                                <div class="row items-push">
                                                    <div class="col-lg-12 border-b">
                                                        ...
                                                        <p class="font-sm text-muted">
                                                            Selama 50 tahun, Minitab telah membantu ribuan perusahaan dan institusi menemukan tren, memecahkan masalah, dan menemukan wawasan berharga dalam data mereka melalui rangkaian alat analisis data dan peningkatan proses kami yang komprehensif dan terbaik di kelasnya.</p>
                                                            <p class="font-sm text-muted">
                                                            Produk senama kami, Perangkat Lunak Statistik Minitab, memimpin dalam analisis data dengan kekuatan untuk memvisualisasikan, menganalisis, dan memanfaatkan data Anda untuk mendapatkan wawasan dan memecahkan tantangan terberat Anda. Akses analitik tepercaya, terbukti, dan modern yang dikombinasikan dengan visualisasi dinamis untuk memberdayakan Anda dan keputusan Anda.</p>
                                                            <p class="font-sm text-muted">
                                                            Versi terbaru dari Minitab Statistical Software mencakup akses ke Minitab di cloud sehingga Anda dapat menganalisis dari mana saja, dan Graph Builder, alat interaktif baru kami untuk langsung membuat beberapa opsi grafik sekaligus. Minitab menawarkan modul untuk Analisis Prediktif dan Perawatan Kesehatan untuk meningkatkan analitik Anda lebih jauh. Tersedia dalam 8 bahasa: Inggris, Cina, Prancis, Jerman, Jepang, Korea, Spanyol, dan Portugis.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- END Ringkasan -->
