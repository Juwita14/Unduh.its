    ...
    <div class="content">
        ...
        <div class="block">
                ...
                <div class="block-content">
                    <a href="ringkasanMathematica/createMathematica" class="btn btn-md btn-success mb-3">TAMBAH RINGKASAN</a>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                            <a href="ringkasanMathematica/editMathematica/{{$r->id}}" >
                                                <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                            </a>
                                        </button>
                                        <form action="ringkasanMathematica/destroyMathematica/{{$r->id}}" method="POST">
                                            @method('delete')
                                            @csrf
