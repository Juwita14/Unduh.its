                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            <form action="/spesifikasiMathematica/updateMathematica/{{$fitur->id}}" method="POST" >
                                @method('PUT')
                                @csrf
                                <div class="form-group row">
                                    <label class="col-12">Fitur</label>
                                    <div class="col-12">
                                        <textarea style="width:715px" class="form-control" name="fitur"  rows="6" placeholder="Ringkasan..">{{$fitur->fitur}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12">
