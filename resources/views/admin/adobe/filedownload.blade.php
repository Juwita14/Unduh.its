                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="filedownload">File Download</a>
                                    </li>
                                    <li>
                ...
                <div class="content">
                    ...
                    <div class="block">
                            ...
                            <div class="block-content">
                                <a href="filedownload/create" class="btn btn-md btn-success mb-3">TAMBAH FILE PANDUAN</a>
                            ...
                            <div class="block-content">
                            <a href="filedownload/createfileInstaller" class="btn btn-md btn-success mb-3">TAMBAH FILE INSTALLER</a>
                                <table class="table table-hover table-vcenter">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 50px;">#</th>
                                    ...
                                    @foreach($file_installer as $fi)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                                        <a href="filedownload/editFI/{{$pd->id}}" >
                                                            <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                                        </a>
                                                    </button>
                                                    <form action="filedownload/destroyFI/{{$pd->id}}" method="POST">
                                                        @method('delete')
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Delete">
                                                            <i style="color:#EF5350" class="fa fa-times"></i>
