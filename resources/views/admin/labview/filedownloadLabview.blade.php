                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <li>
                                    ...
                                    <li>
                                        <a class="active" href="filedownloadLabview">File Download</a>
                                    </li>
                                    <li>
                ...
                <div class="content">
                    ...
                    <div class="block">
                            ...
                            <div class="block-content">
                                <a href="filedownloadLabview/createLabview" class="btn btn-md btn-success mb-3">TAMBAH FILE PANDUAN</a>
                                <table class="table table-hover table-vcenter">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 50px;">#</th>
                                            <th class="d-none d-sm-table-cell" style="width: 40%;">Nama File Panduan</th>
                                            <th class="d-none d-sm-table-cell" style="width: 60%;">File Panduan</th>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                                        <a href="filedownloadLabview/editLabview/{{$pd->id}}" >
                                                            <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                                        </a>
                                                    </button>
                                                    <form action="filedownloadLabview/destroyLabview/{{$pd->id}}" method="POST">
                                                        @method('delete')
                                                        @csrf
                            ...
                            <div class="block-content">
                            <a href="filedownloadLabview/createLabviewFI" class="btn btn-md btn-success mb-3">TAMBAH FILE INSTALLER</a>
                                <table class="table table-hover table-vcenter">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 50px;">#</th>
                                            <th class="d-none d-sm-table-cell" style="width: 40%;">Nama File Installer</th>
                                            <th class="d-none d-sm-table-cell" style="width: 60%;">File Download</th>
                                            <th class="text-center" style="width: 100px;">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($file_installer as $fi)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                                        <a href="filedownloadLabview/editLabviewFI/{{$fi->id}}" >
                                                            <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                                        </a>
                                                    </button>
                                                    <form action="filedownloadLabview/destroyLabviewFI/{{$fi->id}}" method="POST">
                                                        @method('delete')
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Delete">
                                                            <i style="color:#EF5350" class="fa fa-times"></i>
