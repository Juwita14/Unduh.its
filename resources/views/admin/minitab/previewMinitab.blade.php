                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="previewMinitab">Preview</a>
                                    </li>
                ...
                <div class="content">
                    ...
                    <div class="block">
                            ...
                            <div class="block-content">
                                <a href="previewMinitab/createMinitab" class="btn btn-md btn-success mb-3">TAMBAH GAMBAR</a>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                                        <a href="previewMinitab/editMinitab/{{$p->id}}" >
                                                            <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                                        </a>
                                                    </button>
                                                    <form action="previewMinitab/destroyMinitab/{{$p->id}}" method="POST">
                                                        @method('delete')
                                                        @csrf
