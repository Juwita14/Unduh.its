                ...
                <div class="content">
                    ...
                    <div class="block">
                            ...
                            <div class="block-content">
                                <a href="spesifikasiMatlab/createMatlab" class="btn btn-md btn-success mb-3">TAMBAH FITUR</a>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button  type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                                        <a href="spesifikasiMatlab/editMatlab/{{$f->id}}" >
                                                            <i style="color:#3A8CBD"class="fa fa-pencil"></i>
                                                        </a>
                                                    </button>
                                                    <form action="spesifikasiMatlab/destroyMatlab/{{$f->id}}" method="POST">
                                                        @method('delete')
                                                        @csrf
