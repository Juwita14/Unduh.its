                                                ...
                                                <div class="row items-push">
                                                    <div class="col-lg-12 border-b">
                                                        ...
                                                        <p class="font-sm text-muted">
                                                            Sistem definitif dunia untuk komputasi teknis modern. Selama tiga dekade, Mathematica telah mendefinisikan keadaan seni dalam komputasi teknis—dan menyediakan lingkungan komputasi utama bagi jutaan inovator, pendidik, siswa, dan lainnya di seluruh dunia. Dikagumi secara luas karena kecakapan teknis dan kemudahan penggunaan yang elegan.</p>
                                                        <p class="font-sm text-muted">
                                                            Mathematica menyediakan satu sistem terintegrasi yang terus berkembang yang mencakup luas dan kedalaman komputasi teknis — dan tersedia dengan mulus di cloud melalui browser web apa pun, serta secara native di semua sistem desktop modern. Dengan pengembangan energik dan visi yang konsisten selama tiga dekade, Mathematica berdiri sendiri dalam berbagai dimensi, unik dalam dukungannya untuk lingkungan komputasi teknis dan alur kerja saat ini.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- END Classic -->
